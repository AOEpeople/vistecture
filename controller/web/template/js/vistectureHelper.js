...
vistectureHelper.LoadVistectureData = function (
  selectedSubView,
  networkFilterGroups,
  callback
) {
  ...
  $.getJSON(ajaxUrl)
    .done(function (data, statustext, jqXHR) {
      ...
      if (jqXHR.status == 200) {
        ...
        $("#maincontent").html(
          '<div class="mx-auto text-danger m-5" style="max-width: 400px;">Loading error... Server returned invalid statuscode</div>'
        );
    ...
    .fail(function (data) {
      $("#maincontent").html(
        '<div class="mx-auto text-danger m-5" style="max-width: 400px;">Loading error... check server connection</div>'
      );
    });
};
